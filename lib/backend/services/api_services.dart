...
import 'package:nyotapay/backend/model/api_key/api_key_model.dart';
import 'package:nyotapay/backend/model/auth/login/reset_password.dart';
import 'package:nyotapay/backend/model/auth/registation/basic_data_model.dart';
import 'package:nyotapay/backend/model/categories/receive_money/receive_money_model.dart';
...
import '../model/remaining_balance_model/remaining_balance_model.dart';
...
//  update profile  Api method
  ...
  static Future<CommonSuccessModel?> refundApi(
    ...
    try {
      mapResponse =
          await ApiMethod(isBasic: false).post(endPoint, body, code: 200);
      if (mapResponse != null) {
        CommonSuccessModel sendMoneyManualInsertModel =
            CommonSuccessModel.fromJson(mapResponse);
        CustomSnackBar.success(
