...
class WithdrawLogScreen extends StatelessWidget {
  const WithdrawLogScreen({Key? key, required this.controller})
      : super(key: key);
  final TransactionController controller;

  @override
  Widget build(BuildContext context) {
    var data = controller.transactionModel.data.transactions.moneyOut;
    return SizedBox(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [ 
                      ...
                      ExpendedItemWidget(
                        title: Strings.requestAmount.tr,
                        value: data[i].requestAmount,
                      ),
                      ExpendedItemWidget(
