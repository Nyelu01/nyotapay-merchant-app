...
class MakePaymentLogScreen extends StatelessWidget {
  const MakePaymentLogScreen({Key? key, required this.controller})
      : super(key: key);
  final TransactionController controller;

  @override
  Widget build(BuildContext context) {
    var data = controller.transactionModel.data.transactions.makePayment;
    return SizedBox(
                    ...
                    children: [
                      ...
                      data[i].refundActionStatus
                          ? controller.isRefundLoading
                              ? const CustomLoadingAPI(color: CustomColor.whiteColor)
                              : PrimaryButton(
                                  buttonColor:
