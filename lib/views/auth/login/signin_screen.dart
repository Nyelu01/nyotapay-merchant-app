...
import 'package:nyotapay/custom_assets/assets.gen.dart';
...
import 'package:nyotapay/views/others/custom_image_widget.dart';
import 'package:nyotapay/widgets/buttons/custom_text_button.dart';
import 'package:nyotapay/widgets/buttons/primary_button.dart';
import 'package:nyotapay/widgets/others/glass_widget.dart';
  ...
  _titleAndSubtitleWidget(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          TitleHeading2Widget(text: Strings.signInInformation.tr),
          verticalSpace(
