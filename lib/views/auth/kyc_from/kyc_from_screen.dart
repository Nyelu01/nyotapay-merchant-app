...
import 'package:nyotapay/widgets/appbar/back_button.dart';
...
import 'package:nyotapay/widgets/inputs/phone_number_with_contry_code_input.dart';
import 'package:nyotapay/widgets/inputs/primary_input_filed.dart';
    ...
    return Container(
      ...
      child: Obx(
        () => kycController.isLoading
            ? const CustomLoadingAPI()
            : PrimaryButton(
                title: Strings.continueLabel.tr,
                onPressed: () {
